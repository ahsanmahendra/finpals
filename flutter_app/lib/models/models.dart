...
class CategoryModel {
  ...
  final String? color;
  const CategoryModel(
      {required this.categoryId, required this.name, this.icon, this.color});
  ...
  Map<String, dynamic> toJson() =>
      {'category_id': categoryId, 'name': name, 'icon': icon, 'color': color};
}
...
class CategorySummary {
  ...
  factory CategorySummary.fromJson(Map<String, dynamic> json) =>
      CategorySummary(
        name: json['category'] as String? ?? 'Lainnya',
